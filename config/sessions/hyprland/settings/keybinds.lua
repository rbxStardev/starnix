...
-- Gerenciamento de Janelas e Grupos
...
-- Navegação de Foco e Movimentação
...
for i = 1, 10 do
	...
	hl.bind(
		vars.kbGoToWsGroup .. " + " .. key,
		hl.dsp.exec_cmd("~/.config/hypr/scripts/wsaction.sh -g workspace " .. i)
	)
end
